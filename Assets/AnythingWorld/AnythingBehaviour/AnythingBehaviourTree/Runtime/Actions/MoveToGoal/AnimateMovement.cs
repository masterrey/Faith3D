    ...
    public class AnimateMovement : ActionNode
    {
        ...
        public override void OnInit()
        {
            if (context.GameObject.TryGetComponent(out MovementDataContainer container))
            {
                ...
                if (_behaviourType == DefaultBehaviourType.Static || _behaviourType == DefaultBehaviourType.SwimmingAnimal)
                {
                    canRun = false;
                    return;
                }
        ...
        private void PlayMovementAnimation()
        {
            ...
            {
                case DefaultBehaviourType.WalkingAnimal:
                case DefaultBehaviourType.NavMeshWalkingAnimal:
                    PlayGroundAnimalAnimation();
                    break;
                case DefaultBehaviourType.WheeledVehicle:
                    PlayWheeledVehicleAnimation();
                    break;
                case DefaultBehaviourType.FlyingVehicle:
                    PlayFlyingVehicleAnimation();
                    break;
                case DefaultBehaviourType.FlyingAnimal:
