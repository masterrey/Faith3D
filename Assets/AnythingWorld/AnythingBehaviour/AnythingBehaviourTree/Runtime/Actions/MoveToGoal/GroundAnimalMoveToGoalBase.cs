...
namespace AnythingWorld.Behaviour.Tree
{
    ...
    public abstract class GroundAnimalMoveToGoalBase : MoveToGoalBase
    {
        ...
        public override void OnInit()
        {
            ...
            {
                _hasJumpAnimation = _legacyAnimationController.IsJumpAnimationExists();
                _isAnimated = true;
            }
            else
            {
                ...
                {
                    _hasJumpAnimation = _animationController.IsJumpAnimationExists();
                    _isAnimated = true;
                }
            }
        ...
        protected void UpdateMovementAnimation(float currentSpeed)
        {
            ...
            if (_legacyAnimationController)
            {
                _legacyAnimationController.BlendMovementAnimationOnSpeed(currentSpeed);
            }
            else
            {
                _animationController.BlendMovementAnimationOnSpeed(currentSpeed);
            }
        }
