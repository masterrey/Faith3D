...
namespace AnythingWorld.Editor
{
    ...
    {
        [MenuItem("Anything World/About", false, 1)]
        ...
        [MenuItem("Anything World/Discord Support", false, 61)] internal static void RibbonBarDiscordSupport() => System.Diagnostics.Process.Start("https://discord.gg/anythingworld");

        [MenuItem("Anything World/Docs", false, 62)] internal static void RibbonBarDocumentation() => System.Diagnostics.Process.Start("https://anything-world.gitbook.io/anything-world/unity-quickstart");
    }
}
