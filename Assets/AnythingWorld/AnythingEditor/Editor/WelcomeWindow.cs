...
namespace AnythingWorld.Editor
{
    ...
    public class WelcomeWindow : AnythingCreatorEditor
    {
        ...
        /// </summary>
        [MenuItem("Anything World/Welcome")]
        ...
        new void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("Welcome!", new GUIStyle()
            {
            ...
            EditorGUILayout.LabelField("Welcome to Anything World package for Unity!", new GUIStyle()
            {
                alignment = TextAnchor.MiddleCenter,
                fontSize = 10,
                fontStyle = UnityEngine.FontStyle.Bold,
            ...
            EditorGUILayout.LabelField("Browse our library of animated 3D models and start creating!", new GUIStyle()
            {
                alignment = TextAnchor.MiddleCenter,
                fontSize = 10,
                fontStyle = UnityEngine.FontStyle.Bold,
            ...
            // Repaint the window to ensure the latest state is rendered (needed for toggling the "Show at startup" option and hover over the links)
            Repaint();
        }
        /// <summary>
