...
{    
    ...
    public class AudioProcessor
    {
        ...
        /// <returns></returns>
        public static IEnumerator RequestTranscriptionFromSpeechFile(byte[] stream, Action<string> callbackSuccess = null, Action<NetworkErrorMessage> callbackFailure = null, Action<float> callbackLoading = null, params Action<string>[] additinalCallbackSuccess)
        {
        ...
        public static IEnumerator RequestTranscriptionFromSpeechFile(byte[] stream, Action<string> callbackSuccess = null, Action<NetworkErrorMessage> callbackFailure = null, Action<float> callbackUploading = null, Action<float> callbackWaiting = null, params Action<string>[] additionalSuccessCallback)
        {
            if (!AnythingSettings.HasAPIKey) yield break;
            WWWForm form = new WWWForm();
            form.AddBinaryData("speech", stream);
        ...
        /// <returns></returns>
        public static IEnumerator RequestCommandFromSpeechFile(byte[] stream,  Action<NetworkErrorMessage> callbackActionFailure = null, Action<float> callbackActionLoading = null, params Action<string>[] additionalSuccessCallbackActions)
        {
            if (!AnythingSettings.HasAPIKey) yield break;
            WWWForm form = new WWWForm();
            form.AddBinaryData("speech", stream);
        ...
        public static IEnumerator RequestCommandFromSpeechFile(byte[] stream, Action<NetworkErrorMessage> callbackActionFailure = null, Action<float> callbackActionUploading = null, Action<float> callbackActionWaiting = null, params Action<string>[] additionalSuccessCallbackActions)
        {
            if (!AnythingSettings.HasAPIKey) yield break;
            WWWForm form = new WWWForm();
            form.AddBinaryData("speech", stream);
        ...
        /// <param name="additionalSuccessCallbackActions"></param>
        /// <returns></returns>
        public static IEnumerator RequestCommandFromStringInput(string input, Action<NetworkErrorMessage> callbackActionFailure = null, Action<float> callbackActionLoading = null, params Action<string>[] additionalSuccessCallbackActions)
        {
            if (!AnythingSettings.HasAPIKey) yield break;
            WWWForm form = new WWWForm();
        ...
        public static IEnumerator RequestCommandFromStringInput(string input, Action<NetworkErrorMessage> callbackFailure = null, Action<float> callbackUploading = null, Action<float> callbackWaiting = null, params Action<string>[] successCallbacks)
        {
            if (!AnythingSettings.HasAPIKey) yield break;
            WWWForm form = new WWWForm();
            form.AddField("text", input);
