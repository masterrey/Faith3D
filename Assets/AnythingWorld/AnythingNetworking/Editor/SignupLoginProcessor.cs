...
namespace AnythingWorld.Networking.Editor
{
    public static class SignupLoginProcessor
    {
        ...
        {
            CoroutineExtension.StartEditorCoroutine(CheckAPIKeyCoroutine(apiKey, errorDelegate, successDelegate), owner);
        }
        ...
        private static IEnumerator CheckAPIKeyCoroutine(string apiKey, SubmitSignupLoginError errorDelegate, SubmitCredentialsSuccess successDelegate)
        {
