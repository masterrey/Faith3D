...
namespace AnythingWorld.Voice
{
    ...
    public class AnythingVoice
    {
        ...
        public static void ExtractBytesAndProcess(AudioClip clip, OnErrorDelegate onErrorDelegate)
        {
        ...
        public static void RequestCommandsFromString(string input, OnErrorDelegate onErrorDelegate)
        {
            localFailDelegate = onErrorDelegate;
            parsedCommand = null;
            if (input != "")
