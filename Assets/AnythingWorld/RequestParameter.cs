...
namespace AnythingWorld
{
    ...
    public static class RequestParameter
    {
        ...
        internal static bool _useNavMesh = true;
        ...
        /// <summary>
        /// Request model with butt penetration if available.
        /// </summary>
        public static RequestParameterOption IsUsingNavMesh(bool value)
        {
            return new UseNavMesh(value);
        }
        /// <summary>
    ...
    /// <summary>
    /// Use navmesh for animated model movement if available.
    /// </summary>
    public class UseNavMesh : RequestParameterOption
    {
        public UseNavMesh(bool value)
        {
            RequestParameter._useNavMesh = value;
        }
    }
